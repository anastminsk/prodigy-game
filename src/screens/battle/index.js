class Battle {
  constructor(score) {
    ...
    this.enemyNameField = document.getElementById('enemy-name');
  ...
  createHero(hero) {
    ...
    this.playerNameField.textContent = this.hero.name;
  ...
  createEnemy(enemy) {
    ...
    this.enemyNameField.textContent = this.enemy.name;
    this.levelField.textContent = this.enemy.level;
